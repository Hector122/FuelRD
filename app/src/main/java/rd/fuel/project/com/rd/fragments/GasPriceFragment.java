package rd.fuel.project.com.rd.fragments;
...
public class GasPriceFragment extends Fragment implements OnRefreshListener {
    ...
    private void initializerVariables(View view) {
        ...
        getActivity().getIntent().getStringExtra(ActivityConstants.EXTRA_DATA_SOURCE);
    }
    ...
    private void setListViewCustomAdapter(final RssFeedMic mData) {
        ...
        //Set header list.
        customFuelAdapterItems.add(new CustomFuelAdapterItem(AdapterItemType.HEADER_VIEW, title));

        for(Combustible combustible: combustibles){
            customFuelAdapterItems.add(new CustomFuelAdapterItem(AdapterItemType.COMBUSTIBLE_VIEW, combustible));
        }
...
//        mListView.setAdapter(animationAdapter);
    ...
    private void downloadRss() {
        ...
        Client.getDataFromResources(mContext, url);
